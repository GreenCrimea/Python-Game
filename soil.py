...
class SoilLayer:
    def __init__(self, all_sprites):
        ...
        #graphics
        self.soil_surf = pygame.image.load('../Python-Game/graphics/soil/o.png')

        self.create_soil_grid()
        self.create_hit_rects()

    def create_soil_grid(self):
        ground = pygame.image.load("../Python-Game/graphics/world/ground.png")
        ...
        for x,y, __ in load_pygame('../Python-Game/data/map.tmx').get_layer_by_name('Farmable').tiles():
